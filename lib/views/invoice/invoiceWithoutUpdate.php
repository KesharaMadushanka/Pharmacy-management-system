...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-10">
            ...
            <button type="button" class="btn btn-danger btn-lg" id="printPageButton" onClick="document.location.href='../../route/invoice/clearList.php'">Discard
                </button>
